...
function getBaseRate(area: number): number {
  // Find the rate based on area (lookup the largest area that is <= given area)
    ...
    <div className="min-h-screen bg-black text-white">
      <main className="mx-auto max-w-7xl px-6 py-8">
        ...
        <div className="mb-4 text-center">
          <h1 className="text-2xl font-bold">2 Track Aluminium Sliding Window</h1>
        </div>
        ...
        <div className="mb-8">
          ...
          <table className="w-full border-2 border-white">
            <tbody>
              ...
              <tr className="border-b border-white">
                <td className="border-r-2 border-white p-2">Full SS Net</td>
                <td className="border-r-2 border-white p-2 text-center">@50</td>
                <td className="border-r-2 border-white p-2 text-center">
                  {fullSSNet ? `₹${Math.round(calculations.fullSSNetCost)}` : ""}
                </td>
                <td className="border-r-2 border-white p-2 text-center">@50</td>
                <td className="border-r-2 border-white p-2 text-center">
                  {fullSSNet ? `₹${Math.round(calculations.fullSSNetCost)}` : ""}
